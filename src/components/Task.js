...
export default props=>{
    ...
    return(
        <Swipeable renderRightActions={getRigthContente} renderLeftActions={getLeftContente} onSwipeableLeftOpen={()=>props.onDelete && props.onDelete(props.id)}>

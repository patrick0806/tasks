...
const initialState ={showAddTask:false,showDoneTasks:true,visibleTasks:[],tasks:[],}
    ...
    render(){
        ...
        return(
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.addButtom} onPress={()=>{this.setState({showAddTask:true})}} activeOpacity={0.7}>

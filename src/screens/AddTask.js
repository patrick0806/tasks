...
export default class AddTask extends Component{
    ...
    getDatePicker = ()=>{
        let datePicker = <DateTimePicker value={this.state.date || new Date()} onChange={(_,date)=>{this.setState({date,showDatePicker:false})}} mode='date'/>
        ...
        return (
            <Modal transparent={true} visible={this.props.isVisible} onRequestClose={this.props.onCancel} animationType='slide'>
                ...
                <View style={styles.container}>
                    ...
                    <TextInput style={styles.input} placeholder="Informe a Descrição..." value={this.state.desc} onChangeText={text=>{this.setState({desc:text})}}></TextInput>
                    {this.getDatePicker()}
